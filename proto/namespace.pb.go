...
func (x *CreateNodeRequest) GetValue() []byte {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *UpdateNodeRequest) GetValue() []byte {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *NodeUpdate) GetValue() []byte {
	if x != nil {
		return x.Value
	}
	return nil
...
var file_namespace_proto_rawDesc = string([]byte{
	...
	0x63, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c,
	...
	0x01, 0x28, 0x0c, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x29, 0x0a, 0x11, 0x44, 0x65,
